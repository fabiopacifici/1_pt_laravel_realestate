...
<div class="container py-5">
    ...
    <form action="{{route('admin.houses.update', $house)}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="reference_code" id="reference_code" aria-describedby="refCodeHelper" placeholder="ABS12345" value="{{$house->reference_code}}" />
        ...
        <div class="d-flex gap-2">
            ...
            <div class="mb-3 w-100">
                ...
                <input type="text" class="form-control" name="cover_image" id="cover_image" aria-describedby="coverImageHelper" placeholder="https://lorempicsum.com/myimage.png" value="{{$house->cover_image}}" />
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="description" id="description" rows="3" required>{{$house->description}}</textarea>
        </div>


        <div class="mb-3">
            <label for="square_meters" class="form-label">Square Meters</label>
            <input type="number" class="form-control" name="square_meters" id="square_meters" aria-describedby="squareMetersHelper" placeholder="200" value="{{$house->square_meters}}" />
            <small id="squareMetersHelper" class="form-text text-muted">Type the square meters of the property</small>
        </div>

        <div class="mb-3">
            <label for="price" class="form-label">Price</label>
            <input type="number" step="0.01" class="form-control" name="price" id="price" aria-describedby="priceHelper" placeholder="200000" value="{{$house->price}}" required />
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="exterior" id="exterior" aria-describedby="refCodeHelper" placeholder="10ac" value="{{$house->exterior}}" required />
